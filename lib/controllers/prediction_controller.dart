...
class PredictionController extends GetxController {
  ...
  final RxList<PredictionSessionModel> predictionSessions =
      <PredictionSessionModel>[].obs;
  ...
  final Rx<PredictionSessionModel?> currentSession =
  ...
  //     final hasil = _rfService.predict(
  //       input,
  //       '${sessionId}_$i',
  //       data['id'] as String,
  //     );
  ...
  Future<void> submitExcelPrediction() async {
    ...
    try {
      ...
      // await savePredictionSession(session);
      await _firestoreService.savePredictionSession(session);
      predictionSessions.insert(0, session);
      currentSession.value = session;
